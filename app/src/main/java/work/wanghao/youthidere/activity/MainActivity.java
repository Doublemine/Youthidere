...
import work.wanghao.youthidere.fragment.AccountContainerFragment;
...
public class MainActivity extends AppCompatActivity
        ...
        ReadHistoryFragment.AccountInfoFragmentCallback,
        AccountFavoriteFragment.AccountInfoFragmentCallback,
        AccountCommentsFragment.AccountInfoFragmentCallback{
...
//        } 
            ...
            if (ACCOUNT_FLAG == R.layout.activity_login) {
                ...
                switchFragment(AccountContainerFragment.getInstance(), "LoginFragment");
            }
...
//                    break;
                case R.id.nav_account:
                    if (ACCOUNT_FLAG == R.layout.activity_login) {
                        ...
                        mFragmentMgr.beginTransaction().hide(AccountContainerFragment.getInstance()).add(R.id.main_content, to, tag).commit();
                    }
...
//                    break;
                case R.id.nav_account:
                    if (ACCOUNT_FLAG == R.layout.activity_login) {
                        ...
                        mFragmentMgr.beginTransaction().hide(AccountContainerFragment.getInstance()).show(to).commit();
                    }
